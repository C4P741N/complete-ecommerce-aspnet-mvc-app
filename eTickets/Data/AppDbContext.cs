...
{
    public class AppDbContext: DbContext //Made to understand both C# and SQL, acts like a translator
    {

        public AppDbContext(DbContextOptions<AppDbContext> options) : base(options) //constructor (ctor)
        {
